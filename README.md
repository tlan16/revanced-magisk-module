...
[**See the list of patches**](https://tlan16.github.io/rvmm-config-gen/)

 * Star the repo :eyes:
 * Use the repo as a [template](https://github.com/new?template_name=revanced-magisk-module&template_owner=tlan16)
 * Customize [`config.toml`](./config.toml) using [rvmm-config-gen](https://tlan16.github.io/rvmm-config-gen/)
...
### On Termux
```console
bash <(curl -sSf https://raw.githubusercontent.com/tlan16/revanced-magisk-module/main/build-termux.sh)
```
